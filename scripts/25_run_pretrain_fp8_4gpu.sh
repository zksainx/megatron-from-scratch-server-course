...
source "$COURSE_ROOT/configs/4gpu_edu_fp8_mxfp8.env"
...
CKPT_DIR="$RUN_ROOT/checkpoints/pretrain_fp8"
TB_DIR="$RUN_ROOT/tensorboard/pretrain_fp8"
CACHE_DIR="$RUN_ROOT/cache/pretrain_fp8"
...
torchrun \
  ...
  2>&1 | tee "$LOG_DIR/pretrain_fp8.log"
